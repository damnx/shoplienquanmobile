...
class ramdom_nick_lien_quan_mobile_widget extends MY_Widget
{
    public function index()
    {
        ...
        $arr['where'] = array('relationships.candidate_table' =>'product','relationships.foreign_key'=>'97','relationships.foreign_table'=>'category','product.quantity >= '=>'1' ,'deleted' => NULL ,'status' => '1','published <='=>time());
        $data['ramdomProducts'] = $this->product_model->join($arr,8,0);
